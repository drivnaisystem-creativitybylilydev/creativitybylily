...
export default function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#fef5f8] min-h-[85vh] flex flex-col">
      {/* IMAGE LAYER: one continuous background (top row + bottom row, no gap) – text overlay sits on top */}
      <div className="relative flex flex-col gap-0 flex-1 min-h-0">
        {/* Top row: two images + vertical pink blur */}
        <div className="relative flex w-full aspect-[16/5] min-h-[200px] max-h-[360px]">
        ...
        {/* Bottom row: three images + two vertical pink blurs */}
        <div className="relative flex w-full aspect-[16/5] min-h-[160px] max-h-[300px]">
          <div className="hero-image-container relative flex-1 min-w-0 h-full">
      ...
      {/* Soft pink-to-blue gradient overlay on images – pastel, dreamy, doesn't overpower */}
      <div
      ...
      {/* Liquid blurs: multiple organic glows behind text (contrasting colors, no box) */}
      <div
      ...
      />
      <div
        className="absolute left-[35%] top-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none z-[3] w-[min(100%,400px)] h-[min(55vh,260px)]"
        aria-hidden
        style={{
      ...
      />
      <div
        className="absolute left-[65%] top-[45%] -translate-x-1/2 -translate-y-1/2 pointer-events-none z-[3] w-[min(90%,360px)] h-[min(50vh,220px)]"
        aria-hidden
        style={{
      ...
      />
      <div
        className="absolute left-1/2 top-[55%] -translate-x-1/2 -translate-y-1/2 pointer-events-none z-[3] w-[min(70%,320px)] h-[min(40vh,180px)]"
        aria-hidden
        style={{
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none px-2 sm:px-4 md:px-6 z-10">
        <div className="pointer-events-auto w-full max-w-2xl sm:max-w-3xl md:max-w-4xl flex flex-col items-center justify-center py-10 md:py-14 lg:py-16 px-2 sm:px-4 relative">
          {/* Beige oval glow behind heading + subtitle */}
          <div
          ...
          />
          <h1
            className="font-normal leading-tight text-center whitespace-nowrap relative z-[1]"
            style={{
              fontFamily: "var(--font-script)",
              color: "#fff",
              fontSize: "clamp(3.36rem, 8vw, 6.72rem)",
          ...
          <p
            className="mt-0 text-lg md:text-xl lg:text-2xl font-normal text-center relative z-[1]"
            style={{
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center mt-6 md:mt-8 relative z-[1]">
            <Link
              href="/products"
              className="shop-collection-btn bg-[color:var(--logo-pink)] text-white px-8 py-4 rounded-full font-medium text-center inline-block"
              style={{
