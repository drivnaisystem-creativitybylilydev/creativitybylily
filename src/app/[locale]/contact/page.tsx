    ...
    <div className="min-h-screen bg-[#faf8f5] py-20">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="grid gap-12 md:grid-cols-2">
          {/* Contact Information + Follow Us (separate white cards) */}
          <div className="space-y-8">
            <div className="rounded-2xl bg-white p-8 shadow-sm">
              <h2 className="mb-6 font-serif text-2xl font-light text-gray-900">Contact Information</h2>

              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="mt-1">
                    <svg className="h-6 w-6 text-[color:var(--logo-pink)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <div>
                    <h3 className="mb-1 font-semibold text-gray-900">Email</h3>
                    <a href="mailto:creativitybylilyco@gmail.com" className="text-[color:var(--logo-pink)] hover:underline">
            ...
            <div className="rounded-2xl bg-white p-8 shadow-sm">
              ...
              <div className="flex items-center gap-4">
                <a
                  ...
                  className="text-gray-900 transition-colors hover:text-[color:var(--logo-pink)]"
          ...
          {/* Contact Form */}
          <div className="rounded-2xl bg-white p-8 shadow-sm">
            <h2 className="mb-6 font-serif text-2xl font-light text-gray-900">Send us a Message</h2>
